...
```{r p33, message=FALSE,warning=FALSE,echo=FALSE, fig.width=12, fig.height=12}
library(tidyverse)
library(reshape2)
...
```
The heat map indicates the job distribution in King County, using the aggregated data. The tract region has more jobs, as the color becomes darker.
