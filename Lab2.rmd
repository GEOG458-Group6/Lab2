...
t = read.csv("wa_od_main_JT00_2015.csv")
agg_t <- data.frame(t[,1:3]) #3 cols: w_geocode, h_geocode, S000(total no. of jobs)
library(plyr)
library(reshape2)
agg <- aggregate(S000 ~ h_geocode + w_geocode , agg_t, sum) #aggregate the w/h and summerize
library(dplyr)
